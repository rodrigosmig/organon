...
return [
    'added_member'      => 'You have been added to the project',
    'removed_member'    => 'You have been removed from the project',
    ...
    'removed_from_task' => 'You have been removed from the task for'
];
